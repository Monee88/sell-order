<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-wrap">
      ...
      <div class="rating-content"  @ratingtype-select="typeSelect" @content-toggle="toggleContent">
        <ul>
          <li  v-for="rating in ratings" :key="rating.id" v-show="ratingShow(rating.rateType, rating.text)" class="rating-item border-1px">
            <div class="avatar">
